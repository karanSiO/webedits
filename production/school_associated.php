...
<html lang="en">
  <head>
    ...
    <title>CORALearning | School Associated</title>
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>School Associated to CORA</h3>
              </div>
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>List of all the schools ever been associated to CORA</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
					...
					<?php
						...
						$sql = "SELECT DISTINCT(school) FROM $database.additional_field_details WHERE school <> '' ORDER BY school ASC";
