...
<html lang="en">
  <head>
    ...
    <title>CORA Learning | View Issues</title>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Its a log of issues reported to CORA and its status</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
					...
					<?php
						...
						$sql = "SELECT * FROM $database.issue_log ORDER BY date DESC";
						...
						if(mysqli_num_rows($result) > 0) {
							while($store_data = mysqli_fetch_assoc($result)) {
								...
								$wyear = substr($date, 0, 4);
								$wmonth = substr($date, 4, 2);
								$wday = substr($date, 6, 2);
								...
								echo "<td>".$store_data{'email_id'}."</td>";
								echo "<td>".$store_data{'via'}."</td>";
								echo "<td>".$store_data{'issue'}."</td>";
								echo "<td>".$store_data{'technical_failure'}."</td>";
								echo "<td>".$store_data{'comments'}."</td>";
