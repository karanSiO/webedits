          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Its a report of additional details like school, position and discipline of user</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
					...
					<?php
						...
						$sql = "SELECT * FROM $database.additional_field_details ORDER BY userid DESC";
						...
						if(mysqli_num_rows($result) > 0) {
							while($store_data = mysqli_fetch_assoc($result)) {
							  echo "<tr>";
								echo "<td>".$store_data{'userid'}."</td>";
								echo "<td>".$store_data{'email'}."</td>";
								echo "<td>".$store_data{'school'}."</td>";
								echo "<td>".$store_data{'position'}."</td>";
								echo "<td>".$store_data{'discipline'}."</td>";
								echo "</tr>";
							}
						}
						?>
