...
<html lang="en">
  <head>
    ...
    <title>CORALearning | Ongoing Tasks</title>
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					<?php
						...
						$sql = "SELECT * FROM $database.ongoing_tasks ORDER BY status,id,owner DESC";
            ...
            echo '<tr><td><strong><a href="http://training.coralearning.org/manage/data/production/edit_task.php?id='.$id.'">'.$id.'</a></strong></td>';
                echo "<td>".$assign_date."</td>";
                echo "<td>".$task."</td>";
                echo "<td>".$owner."</td>";
                echo "<td>".$status."</td>";
                echo "<td>".$comment_space."</td>";
							}
						}
						?>
                      </tbody>
