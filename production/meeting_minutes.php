      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <div class="row">
              <div class="col-md-6 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Insert New Meeting Minutes</h2>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">

                    <!-- start form for validation -->
                    <form id="demo-form" data-parsley-validate method="POST" action="insert_meeting_minutes.php">
                      <label for="date">Date</label>
                      <input id="startdate" name="date" class="date-picker form-control" required="required" type="text" /><br>
                      
                      <label for="minutes">Minutes</label>
                          <textarea id="minutes" required="required" class="form-control" name="minutes" data-parsley-trigger="keyup" ></textarea>
          ...
          <?php
            ...
            $sql = "SELECT * FROM $database.meeting_minutes ORDER BY date desc";
            ...
            if(mysqli_num_rows($result) > 0) {
              while($store_data = mysqli_fetch_assoc($result)) {
                ...
                $minutes = $store_data{'minutes'};
                $minuted_space = nl2br($minutes);
                echo "<tr><td><strong>".$date."</strong></td></tr>";
                echo "<tr><td>".$minuted_space."</td></tr>";
              }
            }
            ?>
                      </tbody>
